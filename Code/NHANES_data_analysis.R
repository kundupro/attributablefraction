...
PAR_wrong = 1 - 1/(prop_exposure[1] + sum(exp(fit_full$coefficients[2:6])*prop_exposure[-1]))
PAR_wrong_MR = 1 - 1/(prop_exposure[1] + sum(exp(MR_estimates_UK)*prop_exposure[-1]))
PAR_wrong_unadjusted = 1 - 1/(prop_exposure[1] + sum(exp(fit_unadjusted$coefficients[2:6])*prop_exposure[-1]))
